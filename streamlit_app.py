...
def get_facilitator_content_for_mel(stages, mel_id):
    ...
    for stage in stages:
        # Print the entire stage structure for inspection
        st.write(f"Stage ID {stage.get('id')} structure: {json.dumps(stage, indent=2)}")
        
        # Check if the stage has a 'mel_id' field
